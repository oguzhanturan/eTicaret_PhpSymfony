...
class CategoryController extends AbstractController
{
    ...
    {
        $catlist = $repository->findBy(['parentid'=>0]);
     ...
     */
    public function edit(Request $request,$pid,CategoryRepository $repository,Category $category): Response
    {
        $catlist = $repository->findBy(['parentid' => 0]);
        $catname = $repository->findOneBy(['id' => $pid]);
